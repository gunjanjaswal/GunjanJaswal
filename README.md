...
<table><tr><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #2196F3; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/offload%20media%20to%20cloud-2196F3?style=for-the-badge&logo=github&logoColor=white" alt="offload media to cloud"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/offload-media-to-cloud" style="text-decoration: none; color: #2196F3;">offload media to cloud</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Offload Media to Cloud - Seamlessly offload WordPress media to cloud storage — z...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-PHP-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Mar 17-green?style=flat-square"></div></div></td><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #4CAF50; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/Simple%20SES%20Bridge%20For%20Sendy-4CAF50?style=for-the-badge&logo=github&logoColor=white" alt="Simple SES Bridge For Sendy"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/Simple-SES-Bridge-For-Sendy" style="text-decoration: none; color: #4CAF50;">Simple SES Bridge For Sendy</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Connects WordPress to Sendy (via Amazon SES) to create and send newsletters from...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-PHP-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-2-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Mar 26-green?style=flat-square"></div></div></td><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #FF9800; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/BetterDocs%20Scraper-FF9800?style=for-the-badge&logo=github&logoColor=white" alt="BetterDocs Scraper"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/BetterDocs-Scraper" style="text-decoration: none; color: #FF9800;">BetterDocs Scraper</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Python web scraper for BetterDocs documentation sites. Auto-discovers content an...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-Python-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Jan 13-green?style=flat-square"></div></div></td></tr></table>
