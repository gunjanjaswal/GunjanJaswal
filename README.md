...
<table><tr><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #2196F3; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/LoadGate-2196F3?style=for-the-badge&logo=github&logoColor=white" alt="LoadGate"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/LoadGate" style="text-decoration: none; color: #2196F3;">LoadGate</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Pick plugins that should not load on certain front-end URLs. Matching runs befor...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-PHP-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Aug 29-green?style=flat-square"></div></div></td><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #4CAF50; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/AutoloadForge-4CAF50?style=for-the-badge&logo=github&logoColor=white" alt="AutoloadForge"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/AutoloadForge" style="text-decoration: none; color: #4CAF50;">AutoloadForge</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Find what's bloating your autoloaded options and trim it, safely.</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-PHP-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Aug 29-green?style=flat-square"></div></div></td><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #FF9800; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/Block%20Ferry-FF9800?style=for-the-badge&logo=github&logoColor=white" alt="Block Ferry"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/Block-Ferry" style="text-decoration: none; color: #FF9800;">Block Ferry</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Move blocks between WordPress sites. Export a selection or a whole post, import ...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-JavaScript-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Aug 29-green?style=flat-square"></div></div></td></tr></table>
