...
## <img src="https://cdn.simpleicons.org/github/8b949e" height="26" align="top" /> Open Pull Requests <sub>(awaiting review)</sub>
...
<table><tr><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #2196F3; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/AutoLoadForge-2196F3?style=for-the-badge&logo=github&logoColor=white" alt="AutoLoadForge"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/AutoLoadForge" style="text-decoration: none; color: #2196F3;">AutoLoadForge</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">Find what's bloating your autoloaded options and trim it, safely.</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-PHP-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Sep 15-green?style=flat-square"></div></div></td><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #4CAF50; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/WP%20Plugin%20CI-4CAF50?style=for-the-badge&logo=github&logoColor=white" alt="WP Plugin CI"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/WP-Plugin-CI" style="text-decoration: none; color: #4CAF50;">WP Plugin CI</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">GitHub Action: one-step CI for WordPress plugins (PHP lint, readme.txt validatio...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-Shell-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Sep 2-green?style=flat-square"></div></div></td><td align="center" style="vertical-align: top; padding: 10px;"><div style="border: 2px solid #FF9800; border-radius: 15px; padding: 20px; margin: 5px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); width: 280px; height: 300px; display: flex; flex-direction: column; justify-content: space-between;"><div><div style="margin-bottom: 15px;"><img src="https://img.shields.io/badge/WP%20Plugin%20Version%20Guard-FF9800?style=for-the-badge&logo=github&logoColor=white" alt="WP Plugin Version Guard"></div><h3 style="margin: 10px 0; color: #333; font-size: 16px;"><a href="https://github.com/gunjanjaswal/WP-Plugin-Version-Guard" style="text-decoration: none; color: #FF9800;">WP Plugin Version Guard</a></h3><p style="color: #666; font-style: italic; margin: 10px 0; line-height: 1.4; font-size: 14px;">GitHub Action: fail CI when a WordPress plugin version drifts across the header,...</p></div><div style="margin-top: 15px;"><img src="https://img.shields.io/badge/Language-Shell-blue?style=flat-square"> <img src="https://img.shields.io/badge/⭐-0-yellow?style=flat-square"> <img src="https://img.shields.io/badge/Updated-Sep 2-green?style=flat-square"></div></div></td></tr></table>
